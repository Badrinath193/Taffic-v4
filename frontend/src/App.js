      ...
      <section id="simulation" className="tn-section tn-container">
        ...
        <div className="grid-3">
          ...
          <div className="card">
            ...
            <div id="lbl-rows-cols" className="field-lbl">Rows × Cols</div>
            <div className="ctrl-row" role="group" aria-labelledby="lbl-rows-cols">
              ...
              <input aria-label="Cols" className="input" type="number" min="2" max="6" value={simCfg.cols} onChange={(e) => setSimCfg({ ...simCfg, cols: Number(e.target.value) })} data-testid="ctrl-cols" />
            </div>
            <label htmlFor="max-vehicles" className="field-lbl">Max Vehicles</label>
            <input id="max-vehicles" className="input" type="number" min="20" max="800" value={simCfg.max_vehicles} onChange={(e) => setSimCfg({ ...simCfg, max_vehicles: Number(e.target.value) })} data-testid="ctrl-max" />
            ...
            <div style={{ height: 20 }} />
            <div id="lbl-signal-policy" className="field-lbl">Signal Policy</div>
            <div className="ctrl-row" role="group" aria-labelledby="lbl-signal-policy">
      ...
      <section id="ml" className="tn-section tn-container">
        ...
        <div className="grid-2">
          <div className="card">
            ...
            <label htmlFor="episodes" className="field-lbl">Episodes</label>
            <input id="episodes" className="input" type="number" min="5" max="200" value={episodes} onChange={(e) => setEpisodes(e.target.value)} data-testid="train-episodes" />
            <div style={{ height: 10 }} />
            ...
            <div style={{ height: 18 }} />
            <div className="field-lbl">Progress</div>
            ...
            {trainStatus.state === "done" && trainStatus.result && (
              <>
                <div style={{ height: 14 }} />
                <div className="field-lbl">Policy Comparison (learned vs baselines)</div>
      ...
      <section id="osm" className="tn-section tn-container">
        ...
        <div className="grid-2">
          <div className="card">
            ...
            <label htmlFor="osm-place-input" className="field-lbl">Place</label>
            <input id="osm-place-input" className="input" value={osmPlace} onChange={(e) => setOsmPlace(e.target.value)} data-testid="osm-place" />
            <div style={{ height: 10 }} />
            <div className="grid-2" style={{ gap: 10 }}>
              <div>
                <label htmlFor="osm-radius-input" className="field-lbl">Radius (m)</label>
                <input id="osm-radius-input" className="input" type="number" value={osmRadius} onChange={(e) => setOsmRadius(e.target.value)} data-testid="osm-radius" />
              </div>
              <div>
                <label htmlFor="osm-max-nodes-input" className="field-lbl">Max Nodes</label>
                <input id="osm-max-nodes-input" className="input" type="number" value={osmMaxNodes} onChange={(e) => setOsmMaxNodes(e.target.value)} data-testid="osm-max-nodes" />
              </div>
            </div>
            <div style={{ height: 12 }} />
            <div className="ctrl-row">
