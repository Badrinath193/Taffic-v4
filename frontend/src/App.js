      ...
      <section id="simulation" className="tn-section tn-container">
        ...
        <div className="grid-3">
          ...
          <div className="card">
            ...
            <label htmlFor="ctrl-max-input" className="field-lbl">Max Vehicles</label>
            <input id="ctrl-max-input" className="input" type="number" min="20" max="800" value={simCfg.max_vehicles} onChange={(e) => setSimCfg({ ...simCfg, max_vehicles: Number(e.target.value) })} data-testid="ctrl-max" />
            ...
            <div style={{ height: 20 }} />
            <label id="policy-group" className="field-lbl">Signal Policy</label>
            <div className="ctrl-row" role="group" aria-labelledby="policy-group">
      ...
      <section id="ml" className="tn-section tn-container">
        ...
        <div className="grid-2">
          <div className="card">
            ...
            <label htmlFor="train-episodes-input" className="field-lbl">Episodes</label>
